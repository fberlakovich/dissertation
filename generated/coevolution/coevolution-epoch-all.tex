...
\node[defense node] at (2.6,-10.8) {ROPdefender};%
  % Year 2012%
...
\node[attack node] at (-2.6,-18.4) {SROP};%
\node[attack node] at (-6.6,-18.4) {Out of Control};%
\node[attack node] at (-2.6,-19.4) {ROP is Still Dangerous};%
\node[defense node] at (2.6,-17.4) {Oxymoron \allowbreak\cite{Backes2014f}};%
\node[defense node] at (6.6,-17.4) {Modular CFI \allowbreak\cite{niu2014a}};%
...
\node[attack node] at (-6.6,-22.1) {Control Flow Bending \allowbreak\cite{Carlini2015a}};%
...
\node[attack node] at (-2.6,-24.1) {Losing Control};%
...
\node[attack node] at (-6.6,-28.8) {Position Independent ROP};%
\node[defense node] at (2.6,-26.8) {No Execute After Read \allowbreak\cite{Werner2016}};%
\node[defense node] at (6.6,-26.8) {Juggling the Gadgets};%
...
\node[defense node] at (6.6,-29.8) {Intel CET \allowbreak\cite{IntelCET}};%
  % Year 2017%
\node[year node] at (0.0,-31.5) {2017};%
\node[attack node] at (-2.6,-31.5) {Address Oblivious\\ Code Reuse \allowbreak\cite{Rudd2017}};%
...
\node[defense node] at (2.6,-32.0) {SGX{-}Shield};%
\node[defense node] at (6.6,-32.0) {JITGuard};%
  % Year 2018%
\node[year node] at (0.0,-33.2) {2018};%
\node[attack node] at (-2.6,-33.2) {Block{-}Oriented\\ Programming \allowbreak\cite{Ispoglou2018}};%
\node[attack node] at (-6.6,-33.2) {Back To The Epilogue};%
\node[defense node] at (2.6,-33.2) {CFIXX \allowbreak\cite{Burow2018CFIXX}};%
\node[defense node] at (6.6,-33.2) {Compiler Assisted\\ Code Randomization \allowbreak\cite{Koo2018}};%
  % Year 2019%
\node[year node] at (0.0,-34.9) {2019};%
\node[defense node] at (2.6,-34.4) {Origin{-}sensitive CFI};%
\node[defense node] at (6.6,-34.4) {Adaptive Call{-}Site\\ Sensitive CFI};%
\node[defense node] at (2.6,-35.4) {SafeHidden};%
  % Year 2020%
\node[year node] at (0.0,-36.6) {2020};%
\node[attack node] at (-2.6,-36.6) {ROP on RISC{-}V};%
\node[attack node] at (-6.6,-36.6) {Finding Cracks in Shields};%
\node[defense node] at (2.6,-36.6) {Saffire};%
  % Year 2022%
\node[year node] at (0.0,-37.8) {2022};%
\node[defense node] at (2.6,-37.8) {Taming of the Stack};%
  % Year 2023%
\node[year node] at (0.0,-39.0) {2023};%
\node[attack node] at (-2.6,-39.0) {CHOP \allowbreak\cite{duta2023}};%
\node[defense node] at (2.6,-39.0) {R2C};%
