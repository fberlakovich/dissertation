...
\node[defense node] at (6.6,-8.2) {KBouncer \allowbreak\cite{Pappas2013b}};%
  % Year 2013%
\node[year node] at (0.0,-9.9) {2013};%
\node[attack node] at (-2.6,-9.9) {JIT ROP \allowbreak\cite{Snow2013}};%
...
\path[spine,draw] (0.0,0.8) -- (0.0,-11.4);%
\path[use as bounding box] (-8.40,-11.40) rectangle (8.40,2.00);%
\end{tikzpicture}
}