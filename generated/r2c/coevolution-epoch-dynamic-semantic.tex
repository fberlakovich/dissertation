...
\node[defense node] at (6.6,-16.8) {CodeArmor \allowbreak\cite{Chen2017a}};%
  % Year 2018%
\node[year node] at (0.0,-18.0) {2018};%
\node[attack node] at (-2.6,-18.0) {Block{-}Oriented\\ Programming \allowbreak\cite{Ispoglou2018}};%
\node[attack node] at (-6.6,-18.0) {Back To The Epilogue};%
\node[defense node] at (2.6,-18.0) {CFIXX \allowbreak\cite{Burow2018CFIXX}};%
\node[defense node] at (6.6,-18.0) {Compiler Assisted\\ Code Randomization \allowbreak\cite{Koo2018}};%
  % Year 2019%
\node[year node] at (0.0,-19.7) {2019};%
\node[defense node] at (2.6,-19.2) {Origin{-}sensitive CFI};%
\node[defense node] at (6.6,-19.2) {Adaptive Call{-}Site\\ Sensitive CFI};%
\node[defense node] at (2.6,-20.2) {SafeHidden};%
  % Year 2020%
\node[year node] at (0.0,-21.4) {2020};%
\node[attack node] at (-2.6,-21.4) {ROP on RISC{-}V};%
\node[attack node] at (-6.6,-21.4) {Finding Cracks in Shields};%
\node[defense node] at (2.6,-21.4) {Saffire};%
  % Year 2022%
\node[year node] at (0.0,-22.6) {2022};%
\node[defense node] at (2.6,-22.6) {Taming of the Stack};%
  % Year 2023%
\node[year node] at (0.0,-23.8) {2023};%
\node[attack node] at (-2.6,-23.8) {CHOP \allowbreak\cite{duta2023}};%
\node[defense node] at (2.6,-23.8) {R2C};%
\path[spine,draw] (0.0,0.8) -- (0.0,-24.8);%
\path[use as bounding box] (-8.40,-24.80) rectangle (8.40,2.00);%
\end{tikzpicture}