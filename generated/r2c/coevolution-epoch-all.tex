...
\node[defense node] at (6.6,-31.0) {CodeArmor \allowbreak\cite{Chen2017a}};%
  % Year 2018%
\node[year node] at (0.0,-32.2) {2018};%
\node[attack node] at (-2.6,-32.2) {Block{-}Oriented\\ Programming \allowbreak\cite{Ispoglou2018}};%
\node[attack node] at (-6.6,-32.2) {Back To The Epilogue};%
\node[defense node] at (2.6,-32.2) {CFIXX \allowbreak\cite{Burow2018CFIXX}};%
\node[defense node] at (6.6,-32.2) {Compiler Assisted\\ Code Randomization \allowbreak\cite{Koo2018}};%
  % Year 2019%
\node[year node] at (0.0,-33.9) {2019};%
\node[defense node] at (2.6,-33.4) {Origin{-}sensitive CFI};%
\node[defense node] at (6.6,-33.4) {Adaptive Call{-}Site\\ Sensitive CFI};%
\node[defense node] at (2.6,-34.4) {SafeHidden};%
  % Year 2020%
\node[year node] at (0.0,-35.6) {2020};%
\node[attack node] at (-2.6,-35.6) {ROP on RISC{-}V};%
\node[attack node] at (-6.6,-35.6) {Finding Cracks in Shields};%
\node[defense node] at (2.6,-35.6) {Saffire};%
  % Year 2022%
\node[year node] at (0.0,-36.8) {2022};%
\node[defense node] at (2.6,-36.8) {Taming of the Stack};%
  % Year 2023%
\node[year node] at (0.0,-38.0) {2023};%
\node[attack node] at (-2.6,-38.0) {CHOP \allowbreak\cite{duta2023}};%
\node[defense node] at (2.6,-38.0) {R2C};%
\path[spine,draw] (0.0,0.8) -- (0.0,-39.0);%
\path[use as bounding box] (-8.40,-39.00) rectangle (8.40,2.00);%
\end{tikzpicture}