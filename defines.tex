...
\newglossaryentry{vm}{
    name={language VM},
    plural={Language virtual machine},
    description={Language VM}
}
\newglossaryentry{btra}{
    name={BTRA},
    plural={BTRAs},
    description={Booby-trapped return address}
}
\newglossaryentry{heapbt}{
    name={BTDP},
    plural={BTDPs},
    description={Booby-trapped data pointer}
}
...
\newcommand{\propernamedecl}{\ttfamily}
