...
% IEEEtran documentation recommends subfig instead of subfigure and
...
\usetikzlibrary{arrows.meta,arrows,automata,positioning,tikzmark,decorations.pathreplacing,backgrounds}
...
\title{Secure, Fast, Reliable - Pick Three}
...
\chapter{\rtwoc: AOCR-Resilient Diversity with Reactive and Reflective Camouflage}\label{ch:r2c}
