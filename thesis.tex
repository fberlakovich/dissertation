...
\chapter{Plugging Information Leaks With Mimicry}
...
\chapter{Program-State Convolution}
\include{includes/psc/motivation}
\include{includes/psc/background}
\include{includes/psc/unfolding}
\chapter{Fuzzer-Guidance with Optimization-Log Counters}
