...
\title{Secure by Destruction - Compiler-assisted Program Hardening and Fuzzing}
...
\flushbottom
\include{chapters/introduction}\label{ch:introduction}


\chapter{Defending against Code-Reuse with Mimicry}\label{ch:r2c}
\include{chapters/r2c/background}
\include{chapters/r2c/threat-model}
\include{chapters/r2c/design}
\include{chapters/r2c/implementation}
\include{chapters/r2c/evaluation}
\include{chapters/r2c/discussion}
\include{chapters/r2c/future-work}

\chapter{Compiler Fuzzing through Domain-Specific Mutation and Guidance}\label{ch:lool}
\include{chapters/lool/background}
\include{chapters/lool/graalvm-fuzzing}
\include{chapters/lool/design}
\include{chapters/lool/evaluation}
\include{chapters/lool/discussion}
\include{chapters/lool/related-work}
