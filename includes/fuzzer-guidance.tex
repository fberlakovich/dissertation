...
In \cref{ch:psc} we explore an alternative way to incorporate caller context by projecting the context onto code coverage with a compiler transformation.
