...
For example, \gls{CHOP} abuses exception handlers to execute malicious code~\cite{duta2023}, whereas \gls{AOCR} returned to the principle of while-function reuse~\cite{Rudd2017}.
...
Memory-safety techniques try to solve the problem at the root many attack classes, including \glspl{CRA}: memory corruption.
...
Other approaches treat \emph{pointers} as access control subjects associate metadata with memory objects~\cite{Nagarakatte2009,orthen2024}.
