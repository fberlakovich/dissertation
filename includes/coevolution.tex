...
A particularly common and dangerous class of memory corruption exploits are \glspl{CRA} and their, now mostly obsolete, predecessor code-injection attacks.
...
Together with increasingly sophisticated variants of \glspl{CRA}, defenses in each category have also evolved alongside.
...
Especially earlier \gls{CFI} implementations limited themselves to pure control-flow restrictions without taking dataflow (\eg \code{param > 3}) into account.
...
In the \gls{ROP} attacks from this era (2005--2013), collecting gadgets happens offline and before the actual attack, typically on a separate copy of the target binary.
