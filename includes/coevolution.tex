...
As a response to \gls{JITROP} and \gls{BROP}, researchers also upgraded their defenses to provide \emph{leakage-resilience} in combination with booby traps~\cite{Crane2015}.
...
The idea behind re-randomization is that knowledge about the code layout becomes stale before an attacker can exploit it.
