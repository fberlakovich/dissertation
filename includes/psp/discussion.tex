...
\begin{table}[t]
    ...
    \scriptsize
    \loadTableData{generated/psp/entanglement-fuzzbench}
    \begin{thesistable}[expand=\tabledata]{
        colspec = {l S[table-format=2.1] S[table-format=3.1] S[table-format=2.1] S[table-format=2.1] S[table-format=2.1] S[table-format=3.1] S[table-format=2.1] S[table-format=2.1]},
        headrows = 2,
        cell{3-Z}{1} = {font=\propernamedecl},
    }
        \toprule
        & \SetCell[c=4]{c} {\gls{VRP}} & & & & \SetCell[c=4]{c} {Call Unfolding} & & & \\
...
\begin{table}[t]
    ...
    \scriptsize
    \loadTableData{generated/psp/entanglement-magma}
    \begin{thesistable}[expand=\tabledata]{
        colspec = {l S[table-format=3.1] S[table-format=2.1] S[table-format=2.1] S[table-format=2.1] S[table-format=3.1] S[table-format=2.1] S[table-format=2.1] S[table-format=2.1]},
        headrows = 2,
        cell{3-Z}{1} = {font=\propernamedecl},
    }
        \toprule
