...
Here we present an alternative solution to the problem, which we call \acrfull{PSP}.
...
We call this principle \emph{Program State Projection}, or \gls{PSP} for short, because it combines control flow with parts of the program's hidden state.
