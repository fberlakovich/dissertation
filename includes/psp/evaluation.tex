...
\begin{table}[t]
    ...
    \scriptsize
    \loadTableData{generated/psp/coverage-fuzzbench}
    \begin{thesistable}[expand={\tabledata,\shadecell}]{
        colspec = {l S[table-format=+4.0,retain-explicit-plus,table-number-alignment=right,group-separator={,},group-minimum-digits=4] S[table-format=+2.1,retain-explicit-plus,table-number-alignment=right] S[table-format=1.2,table-number-alignment=right] S[table-format=1.3,table-number-alignment=right,table-text-alignment=right] S[table-format=+4.0,retain-explicit-plus,table-number-alignment=right,group-separator={,},group-minimum-digits=4] S[table-format=+2.1,retain-explicit-plus,table-number-alignment=right] S[table-format=1.2,table-number-alignment=right] S[table-format=1.3,table-number-alignment=right,table-text-alignment=right]},
        headrows = 2,
        cell{3-Z}{1} = {font=\propernamedecl},
        colsep = 3pt,
        column{2} = {leftsep=5pt},
        column{6} = {leftsep=7pt},
    }
        \toprule
        & \SetCell[c=4]{c} {VRP} & & & & \SetCell[c=4]{c} {Call Unfolding} & & & \\
...
\begin{table}[t]
    ...
    \footnotesize
    \loadTableData{generated/psp/bugs-magma}
    \begin{thesistable}[expand={\tabledata,\shadecell}]{
        colspec = {l l S[table-format=2.0] S[table-format=2.0] S[table-format=4.0] S[table-format=4.0] S[table-format=2.0] S[table-format=2.0] S[table-format=4.0] S[table-format=4.0]},
        headrows = 2,
        cell{3-Z}{1-2} = {font=\propernamedecl},
    }
        \toprule
        & & \SetCell[c=4]{c} {VRP} & & & & \SetCell[c=4]{c} {Call Unfolding} & & & \\
...
\begin{table}[t]
    ...
    \loadTableData{generated/psp/coverage-magma}
    \begin{thesistable}[expand={\tabledata,\shadecell}]{
        colspec = {l S[table-format=+4.0,retain-explicit-plus,table-number-alignment=right,group-separator={,},group-minimum-digits=4] S[table-format=+2.1,retain-explicit-plus,table-number-alignment=right] S[table-format=1.2,table-number-alignment=right] S[table-format=1.3,table-number-alignment=right,table-text-alignment=right] S[table-format=+4.0,retain-explicit-plus,table-number-alignment=right,group-separator={,},group-minimum-digits=4] S[table-format=+2.1,retain-explicit-plus,table-number-alignment=right] S[table-format=1.2,table-number-alignment=right] S[table-format=1.3,table-number-alignment=right,table-text-alignment=right]},
        headrows = 2,
        cell{3-Z}{1} = {font=\propernamedecl},
