...
\subsection{Research Questions}\label{psp:ss:research-questions}
% RQ1: Does VRP improve edge coverage compared to baseline AFL++?
% RQ2: Does indirect call unfolding improve edge coverage?
% RQ3: Do PSP transformations affect fuzzing throughput?
% RQ4: Do PSP transformations improve bug-finding capability (Magma)?
...
\subsection{Fuzzing Throughput}\label{psp:ss:throughput}
...
\subsection{Statistical Analysis}\label{psp:ss:statistics}
% Methodology:
...
\subsection{Discussion}\label{psp:ss:discussion}
% -----------------------------------------------------------------------------
...
\todo{Implement evaluation based on above outline. Data: data/psp/dataframes/vrp-unfold-eval01.zip}
