...
Whereas in \cref{part:defense} the compiler helped us to hide information from an attacker, in this part we aim to expose implicit information to the fuzzer.
...
Finally, we introduce \emph{Program State Projection} (PSP), a technique that uses compiler analyses to project hidden data dependencies onto observable control flow.
We evaluate \gls{PSP}'s effectiveness on real-world benchmarks.
