\section{Optimization-Driven Mutation}\label{s:lool:design}
...
\begin{figure}
    ...
    The differently shaded areas differentiate the GraalVM fuzzing framework (see \cref{lool:ss:graalvm-fuzzing}) from \lool's components (see \cref{s:lool:design}).}
