...
As JIT compilers form only \emph{part} of a language VM, JIT compiler fuzzers face a specific fourth challenge:
...
\fbetodo{add system architecture figure}
...
Specifically, LeJit automatically extracts Java templates from existing code and replaces concrete expresions with holes.
...
While classfuzz uses code coverage feedback, the produced class are often invalid and, thus, do not reach the \gls{JITcomp}.
...
\fbetodo{Integrate swarm testing into background}
...
GraalVM also includes the Truffle language implementation framework~\cite{wuerthinger2013}.
...
The goal of later sections is to demonstrate the principle of optimization-log coverage (see \cref{s:lool:design}).
...
\subsubsection{Input Program Generation}\label{ss:input-program-generation}
...
static class Class1 {
  ...
  public boolean Class1_method0(Boolean param0, double param1) {
    ...
    boolean var4 = FuzzerUtils.randomBoolean();
    boolean var5 = param0;
    boolean var3 = FuzzerUtils.randomBoolean();
    float var2 = 3.975332E8f;
    boolean var7 = FuzzerUtils.randomBoolean();
    ...
    var6 = 0;
    loop1: while (((!(var4 ? var4 : var5)) ? Character.isLetter(var1) : ((var3 ? ((float) param1) : var2) > (-1.0f))) ? ((var0 ? (var0 ? true : param0) : false) && Double.isInfinite(param1))
      : (Boolean.valueOf(((boolean) param0)) ? Boolean.TRUE : false)) {
    var1 = (char) ((((((FuzzerUtils.hashCode(var7) & var8.length) / (var10 + 34)) / (var11 + 105)) / (var12.length + 802)) - var13) - var14.length);
    ...
    var12 = var5 ? (param0
        ? new String[]{var9, ("\\'\\u000f�.�^,")}
        : (var3 ? new String[]{("��\\u001f\\u0002-�=R�����l�:")} : new String[]{var9}))
        : ((param0 | var5)
        ? (var0 ? new String[]{var9, ("\\u0005��.�2�Q")} : new String[]{var9, ("�Ng��\\\\0�v���")})
