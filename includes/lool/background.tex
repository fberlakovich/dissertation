...
static class Class1 {
  ...
  public boolean Class1_method0(Boolean param0, double param1) {
    ...
    var6 = 0;
    loop1: while (((!(var3 ? var3 : var5)) ?
        Character.isLetter(var1) : ((var3 ? ((float) param1) : var2) > (-1.0f))) ? ((var0 ? (var0 ? true : param0) : false) && Double.isInfinite(param1))
    ...
    var6 = var6 + 1;
    var12 = var5 ? (param0 ? new String[]{var9, ("\\'\\u000f\xbd.\xef\xbf\xbd^,")}
        : (var3 ? new String[]{("\\u0002-=R\xef\xbf\xbd:")} : new String[]{var9}))
        : ((param0 | var5)
