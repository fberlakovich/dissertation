...
This advantage in code coverage is not, however, reflected in the achieved rare optimization scores (see \cref{lool:fig:rare-opts,fig:rare-pairs}).
...
\cref{lool:fig:rare-opts,fig:rare-pairs} show that \propername{genetic-code} nonetheless triggers a similar amount of rare optimizations and pairs.
...
Configurations using the genetic algorithm consistently trigger more rare optimizations and optimization pairs than their \aflpp counterparts (see \cref{lool:fig:rare-opts,fig:rare-pairs}).
...
\cref{lool:fig:rare-opts,fig:rare-pairs} show that code coverage feedback triggers fewer rare optimizations and optimization pairs.
...
Cumulative code coverage (\cref{lool:fig:cumulative-coverage}) and rareness scores (\cref{lool:fig:rare-opts,fig:rare-pairs}) suggest that context-aware coverage is less beneficial than context-blind coverage.
