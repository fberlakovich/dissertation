...
\begin{listing}[t]
    \centering
    \begin{sublisting}[t]{0.48\textwidth}
...
invokestatic  #60
        \end{minted}
        \caption{Uninstrumented bytecode}
        \label{lool:lst:bytecode-uninstrumented}
    \end{sublisting}
    \hfill
    \begin{sublisting}[t]{0.48\textwidth}
...
invokestatic  #60
        \end{minted}
        \caption{Coverage-instrumented bytecode}
        \label{lool:lst:bytecode-instrumented}
    \end{sublisting}
...
if (bytes[0] == 'b') {
    ...
    \end{sublisting}
    \caption{Java \code{if} cascade and corresponding bytecode instrumented for code coverage. Highlighted lines show inserted coverage tracking.}
