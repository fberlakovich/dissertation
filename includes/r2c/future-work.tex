...
set_up_target:
 ...
 ret
    ...
    \begin{minipage}[b]{0.7\linewidth}
        \includeDrawioFigure[0.9\linewidth]{figures/r2c/btra-only-stack}[remember picture]{
    ...
    \end{minipage}
    \caption{Retpolines and how speculation-aware booby-traps can use the retpoline principle for deception.}
\end{figure}
