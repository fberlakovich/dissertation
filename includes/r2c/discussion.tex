...
\begin{table}[t]
    \centering
    \begin{thesistable}{
        colspec = {l S[table-format=12.0,table-alignment-mode=none,table-number-alignment=right] @{\hskip 2em} l S[table-format=12.0,table-alignment-mode=none,table-number-alignment=right]},
        headrows = 1,
        cell{2-Z}{1} = {font=\propernamedecl},
        cell{2-Z}{3} = {font=\propernamedecl},
    }
        \toprule
        Benchmark & {Call Frequency} & Benchmark & {Call Frequency} \\
        \midrule
        perlbench & 9435182963       & x264      & 3400115007       \\
        gcc       & 7471474392       & deepsjeng & 11366032234      \\
        mcf       & 38657893688      & imagick   & 10441212712      \\
        lbm       & 20906700         & leela     & 13108456661      \\
        omnetpp   & 23536583520      & nab       & 135237228510     \\
        xalancbmk & 12430137048      & xz        & 3287645643       \\
        \bottomrule
    \end{thesistable}
...
\loadTableData{generated/r2c/btra-steps}
\begin{table}[t]
    \centering
...
\begin{figure}[t]
    ...
    \pgfplotsset{
        every axis/.append style={
            ...
            legend style={font=\propernamedecl},
    ...
    \resizebox{0.9\textwidth}{!}{\input{figures/r2c/btra-instr-vs-cycles}}%
    \endgroup
...
The relative numbers can be misleading, however.
A comparison of the L1 and L2 miss rates and a relatively low increase in L2 stall cycles suggests that the L2 cache absorbs most of the L1 misses and the L3 cache most of the L2 misses.
...
\loadTableData{generated/r2c/ipc-progression}
\begin{table}[t]
    \centering
    ...
    \begin{thesistable}[expand=\tabledata]{
        ...
        \toprule
        & & \SetCell[c=6]{c} \glspl{BTRA} ($\Delta$\%) & & & & & \\
        \cmidrule[lr]{3-8}
...
\begin{table}[t]
    ...
    \begin{thesistable}{
        colspec = {l S[table-format=4.0] S[table-format=2.1] S[table-format=2.1]},
        headrows = 1,
        cell{2-Z}{1} = {font=\propernamedecl},
    }
        \toprule
        ...
        \midrule
        x264      & 867                  & 3.4         & 3.9       \\
        deepsjeng & 1957                 & 11.4        & 5.8       \\
        leela     & 1638                 & 13.1        & 8.0       \\
        perlbench & 994                  & 9.4         & 9.5       \\
        gcc       & 781                  & 7.5         & 9.6       \\
        xalancbmk & 1053                 & 12.4        & 11.8      \\
        mcf       & 1965                 & 38.7        & 19.7      \\
        omnetpp   & 1020                 & 23.5        & 23.1      \\
        \bottomrule
    \end{thesistable}
\end{table}
...
\begin{table}[t]
    ...
    \begin{thesistable}{
        ...
        \toprule
        & \SetCell[c=2]{c} \propername{nginx} & & \SetCell[c=2]{c} \propername{Apache} & & \SetCell[c=2]{c} \propername{Lighttpd} & \\
