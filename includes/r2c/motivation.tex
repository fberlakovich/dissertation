...
\begin{figure}[t]
    ...
    \caption{Prior systems primarily diversify code, leaving the layout of observable data predictable (left vs middle, see \cref{r2c:ss:aocr}).
    \rtwoc (right) diversifies code and observable data.}
    \vspace*{-1em}
    \label{r2c:fig:overview-unprotected}
\end{figure}