...
\fbetodo{more details on the LLVM implementation}
...
\fbetodo{Describe why vzeroupper is needed}
...
\subsubsection{Stack Arguments}\label{r2c:sss:stack-arguments}
 ...
 \begin{figure}[t]
     ...
     \begin{subfigure}[t]{0.45\linewidth}
         \centering
         \includegraphics[width=0.9\linewidth]{figures/r2c/r2c-parameter-addressing-plain}
     ...
     \begin{subfigure}[t]{0.45\linewidth}
         \centering
         \includegraphics[width=0.9\linewidth]{figures/r2c/r2c-parameter-addressing-btra}
