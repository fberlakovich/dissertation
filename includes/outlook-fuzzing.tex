...
Recent work suggests, however, that the engineering choices made for AFL, such as the coverage map size, might no longer be in line with modern hardware~\cite{sarafov2024}.
