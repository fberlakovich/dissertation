...
Each strategy is effectively a compromise between different security, performance and compatibility.
...
In other words, software diversity aims to break the assumption that because an exploit works on once target instance, it also works on another.
