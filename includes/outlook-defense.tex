...
Such an inference is only possible (at least reliably), however, due to the specific layout of the \gls{CPH} table.
...
Another issue is the lack of metrics describing security capabilities of a defense.
...
In light of new challenges such as \gls{JITROP} and new diversification techniques that reach far beyond the gadget level, however, a new metric is needed.
