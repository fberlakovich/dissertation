...
Our evaluation on FuzzBench and Magma benchmarks, however, did not show a statistically significant improvement in coverage or bug finding.
This suggests that the tested heuristics are insufficient or that longer campaigns and different benchmark characteristics are needed.
...
Taken together, these contributions show that a compiler's role goes beyond optimization and that compiler knowledge can yield novel solutions when applied to problems aside from compilation itself.
