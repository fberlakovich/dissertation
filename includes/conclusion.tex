...
By repurposing these analyses to transform data dependencies into control dependencies, PSP provides stepping stones that help fuzzers explore deeper into the state space.
