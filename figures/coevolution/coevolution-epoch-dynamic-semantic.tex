...
\node[attack node] at (-2.6,-4.2) {SROP \allowbreak\cite{bosman2014}};%
\node[attack node] at (-6.6,-4.2) {Out of Control \allowbreak\cite{Goktas2016b}};%
\node[attack node] at (-2.6,-5.2) {ROP is Still Dangerous \allowbreak\cite{carlini2014}};%
\node[defense node] at (2.6,-3.2) {Oxymoron \allowbreak\cite{Backes2014f}};%
\node[defense node] at (6.6,-3.2) {Modular CFI \allowbreak\cite{niu2014}};%
...
\node[attack node] at (-6.6,-7.9) {Control Flow Bending \allowbreak\cite{Carlini2015}};%
...
\node[attack node] at (-2.6,-9.9) {Losing Control \allowbreak\cite{conti2015}};%
...
\node[defense node] at (6.6,-12.6) {Juggling the Gadgets \allowbreak\cite{koo2016}};%
...
\node[defense node] at (6.6,-15.6) {Intel CET \allowbreak\cite{IntelCET}};%
  % Year 2017%
\node[year node] at (0.0,-16.8) {2017};%
\node[attack node] at (-2.6,-16.8) {Address Oblivious\\ Code Reuse \allowbreak\cite{Rudd2017}};%
...
\node[defense node] at (6.6,-16.8) {CodeArmor \allowbreak\cite{Chen2017a}};%
  % Year 2018%
\node[year node] at (0.0,-18.5) {2018};%
\node[attack node] at (-2.6,-18.0) {Block{-}Oriented\\ Programming \allowbreak\cite{Ispoglou2018}};%
\node[attack node] at (-6.6,-18.0) {Back To The Epilogue \allowbreak\cite{biondo2018}};%
\node[attack node] at (-2.6,-19.0) {Position Independent\\ ROP \allowbreak\cite{Goktas2018}};%
\node[defense node] at (2.6,-18.5) {CFIXX \allowbreak\cite{Burow2018CFIXX}};%
\node[defense node] at (6.6,-18.5) {Compiler Assisted\\ Code Randomization \allowbreak\cite{Koo2018}};%
  % Year 2019%
\node[year node] at (0.0,-20.7) {2019};%
\node[defense node] at (2.6,-20.2) {Origin{-}sensitive CFI \allowbreak\cite{khandaker2019}};%
\node[defense node] at (6.6,-20.2) {Adaptive Call{-}Site\\ Sensitive CFI \allowbreak\cite{khandaker2019a}};%
\node[defense node] at (2.6,-21.2) {SafeHidden \allowbreak\cite{wang2019a}};%
  % Year 2020%
\node[year node] at (0.0,-22.4) {2020};%
\node[attack node] at (-2.6,-22.4) {ROP on RISC{-}V \allowbreak\cite{jaloyan2020}};%
\node[attack node] at (-6.6,-22.4) {Finding Cracks\\ in Shields \allowbreak\cite{li2020}};%
  % Year 2022%
\node[year node] at (0.0,-23.6) {2022};%
\node[defense node] at (2.6,-23.6) {Taming of the Stack \allowbreak\cite{huang2022a}};%
  % Year 2023%
\node[year node] at (0.0,-24.8) {2023};%
\node[attack node] at (-2.6,-24.8) {CHOP \allowbreak\cite{duta2023}};%
\node[defense node] at (2.6,-24.8) {R2C \allowbreak\cite{berlakovich2023}};%
