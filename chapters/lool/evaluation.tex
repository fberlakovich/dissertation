...
\subsection{Experiment Evaluation}\label{ss:experiment-evaluation}
...
\begin{itemize}
    \item amount of code coverage, measured as edge coverage (see \cref{sss:eval-code-coverage})
...
\cref{tbl:afl-overview} gives an overview of the total number of tests (sum of all runs) in each experiment.
...
\cref{tbl:coverage-overhead} shows the test case throughput decrease for each coverage type.

\subsection{Code Coverage}\label{sss:eval-code-coverage}
\begin{figure}[t]
    \centering
    \begingroup
    ...
    See \cref{ss:experiment-evaluation} and \cref{sss:eval-code-coverage} for details}.
    \label{fig:cumulative-coverage}
\end{figure}
...
\begin{figure}[t]
    ...
    See \cref{fig:cumulative-coverage} for the full graph.
    The legend is ordered based on the achieved median cumulative coverage after 24 hours.}
    \label{fig:cumulative-coverage-upper}
\end{figure}
...
\cref{fig:cumulative-coverage} shows the cumulative code coverage of different configurations over time.
...
The legend is ordered based on the achieved median cumulative coverage after 24 hours.
To better distinguish the densely packed upper group, \cref{fig:cumulative-coverage-upper} shows the upper group of configurations after 4 hours and without the interquartile range.
